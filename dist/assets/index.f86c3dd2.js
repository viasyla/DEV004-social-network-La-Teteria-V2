...
const btnLogin = () => {
  ...
  botonLogin.textContent = "Iniciar Sesi\xF3n";
  return botonLogin;
};
const btnVolverHome = () => {
...
const home = () => {
  document.querySelector("body").classList.add("home__body");
  ...
  div2.append(botonRegistro, botonLogin);
...
const registro = () => {
  document.querySelector("body").classList.add("registro__body", "todo-body");
  ...
  inputPassword.classList.add("registro-inputs");
